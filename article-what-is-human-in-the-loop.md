...
Underneath all four moves, keep every governed action on the **RAIL**: [Reversible](rail-reversible.html), [Authorized](rail-authorized.html), [Interruptible](rail-interruptible.html), and [Logged](rail-logged.html). An action that satisfies those four leaves even a missed review recoverable, scoped, stoppable, and accountable.
