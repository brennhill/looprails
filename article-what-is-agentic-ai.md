...
Now that you can answer *what is agentic AI*, the next step is to govern one. Run your agent's riskiest actions through the [interactive grader](index.html#grader) to see their G0 to G3 grade and the controls that match, then put the [LoopRails framework](framework.html) to work. The shift from reviewing outputs to governing actions is the whole job, and the sooner you make it, the safer your agents get.
